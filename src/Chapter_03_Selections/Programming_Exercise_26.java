...
public class Programming_Exercise_26 
{
	public static void main(String[] args) 
	{
		...
		{
			System.out.println(divisible + " is divisible by 5 and 6.");
		}
		if (((divisible % 5) == 0) || ((divisible % 6) == 0))
		{
			System.out.println(divisible + " is divisible by 5 or 6.");
		}
		if (((divisible % 5) == 0) ^ ((divisible % 6) == 0))
		{
			System.out.println(divisible + " is divisible by 5 xor 6.");
		}
